...
chown -v `stat -f %u:%g "$TRGT/home/$ADMIN_ACCT"` "$TRGT/home/$ADMIN_ACCT/.ssh"
chmod 700 "$TRGT/home/$ADMIN_ACCT/.ssh"
...
EOF
chown -v `stat -f %u:%g "$TRGT/home/$ADMIN_ACCT"` "$TRGT/home/$ADMIN_ACCT/.ssh/authorized_keys"
